...
addpath('utils')
load('/home/adharsh/Projects/IT/SS/DBSRCNN/test/models/DBSRCNN_blur1.mat')

% set parameters
up_scale = 3;

%% change the number according to sigma (1,2,3,4) of non-blind blurring in training.
 j=4; % values 1,2,3,4 (according to blurring level)
...
im_path = '/home/adharsh/Projects/IT/SS/DBSRCNN/test/Data/Set5/';  
...
im_l = imresize(X, 1/up_scale, 'bicubic')/255; % downsampling the images by using factor = up_scale
